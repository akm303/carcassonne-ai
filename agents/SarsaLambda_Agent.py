...
class SarsaLambdaAgent(Agent):
    ...
    def getAction(self, game: CarcassonneGame):
        ...
        4) Update Q for the previous (s, a) using Sarsa(Lambda):
            - betta = r + gamma * Q(s', a') - Q(s, a)
            - Update traces for all (s, a): e(s, a) <- gamma * lambda * e(s, a)
            - Update the current trace: e(s,a) += 1
            - Update Q for all (s, a): Q(s,a) <- Q(s, a) + alpha * betta * e(s, a)
